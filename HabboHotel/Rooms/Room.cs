...
namespace Butterfly.HabboHotel.Rooms
{
    ...
    public class Room
    {
        ...
        internal List<Chatlogs.Chatlog> LoggedMessages = new List<Chatlogs.Chatlog>();


        internal void LogMessage(Chatlogs.Chatlog Chatlog)
        {
            if (LoggedMessages.Count >= 100)
            {
                LoggedMessages.Clear();
            }

            LoggedMessages.Add(Chatlog);
        }
