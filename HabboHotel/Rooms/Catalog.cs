...
namespace Butterfly.Messages
{
    partial class GameClientMessageHandler
    {
        ...
        internal void HandlePurchase()
        {
            ...
            ButterflyEnvironment.GetGame().GetCatalog().HandlePurchase(Session, PageId, ItemId, ExtraData, false, "", "", Session.GetHabbo().buyItemLoop);
        ...
        internal void PurchaseGift()
        {
            ...
            ButterflyEnvironment.GetGame().GetCatalog().HandlePurchase(Session, PageId, ItemId, ExtraData, true, GiftUser, GiftMessage, 1);
        }
